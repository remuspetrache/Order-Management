...
public class ProductView extends JFrame {
    ...
    /**
     * View for the product operations
     */
    public ProductView() {
        ...
        JLabel addLabel = new JLabel("Add a new product");
        ...
        JLabel editLabel = new JLabel("Edit product with id:");
        editLabel.setHorizontalAlignment(SwingConstants.CENTER);
        editLabel.setBounds(90, 130, 125, 15);
        contentPane.add(editLabel);

        editField = new JTextField();
        editField.setBounds(215, 129, 35, 20);
        ...
        JLabel deleteLabel = new JLabel("Delete product with id:");
        ...
        deleteField.setBounds(225, 194, 35, 20);
        ...
        JLabel viewLabel = new JLabel("View all products");
    ...
    /**
     * Adds action listener for the add product button
    ...
    /**
     * Adds action listener for the edit product button
    ...
    /**
     * Adds action listener for the delete product button
    ...
    /**
     * Adds action listener for the view products button
    ...
    /**
     * Gets the id of the product to be edited
